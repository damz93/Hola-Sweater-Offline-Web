	...
	?>
      ...
      <table border="1" style="width: 100%" align='left'>
         ...
         <?php 
            ...
            $jumqty = $data['JUMLAH_QTY'];
            $costumer = $data['COSTUMER'];
			$jumqtytamp = number_format($jumqty,0,',','.');     
            $potongan = $data['POTONGAN'];
			$potongantamp = "Rp" . number_format($potongan,0,',','.');     
            $total_barang = $data['TOTAL_BARANG'];
			$total_barangtamp = "Rp" . number_format($total_barang,0,',','.');     
            $tgltrans = $data['TGL'];
            $nambar = $data['JENIS_BARANG'];
			$tot_bersih = $total_barang-$potongan;
			
            $tot_bersihtamp = "Rp" . number_format($tot_bersih,0,',','.');      
            $kuant = $data['QTY'];
         ...
         <tr>
            ...
            <td align='center'><?php echo $jumqtytamp; ?></td>            
            <td align='right'> <?php echo $total_barangtamp; ?></td>
			<td align='right'> <?php echo $potongantamp; ?></td>
            <td align='right'> <?php echo $tot_bersihtamp; ?></td>
         </tr>
		 <tr>
		 <?php
			  }
