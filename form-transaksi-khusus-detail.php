...
<html>
	...
	<body>
		<div class="bg">
			...
			<a style="background-color:#71b8e4;color:#FFFFFe" href="form-transaksi-khusus.php"> KEMBALI KE FORM TRANSAKSI </a><br><br>
			<?php
			...
			<table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
				...
				<?php
						...
						//$ongkirr = 0;
						$order = mysqli_query($koneksi, "select * from t_transaksi_khusus where KODE_TRANSAKSI='".$kode_transaksi."' ORDER BY JENIS_BARANG,WARNA ASC");
	...
	<script>
		...
		//	   var link = document.getElementById("edit_"+kod_bar);
			  ...
			  //alert('tes');
			var linkkk = "update-payment-khusus.php?kode_transaksi="+kod_tr+"&paym="+paym;
