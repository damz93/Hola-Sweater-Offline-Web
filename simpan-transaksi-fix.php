<?php
   ...
   //include 'csrf.php';
	...
	/*	$selectcostum = mysqli_query($koneksi,"select * from t_costum where KODE_COSTUM='$kode_costum'");
		...
		if (strlen($warna)!=0){			
			//$query = "INSERT into t_transaksi_temp(KENA,KODE_COSTUM,POTONGAN,COSTUM,KODE_BARANG,KODE_DISKON,JENIS_BARANG,HARGA,HARGA_TAMBAHAN,QTY,TOTAL,TOTAL2,SIZE_,WARNA,KETERANGAN,WAKTU,TGL,OLEH) VALUES('$kena','$kode_costum','$potongan','$ket_costum','$kode_barang','$kode_promo','$jenis_barang','$harga_satuan','$totcost','$qty','$total_harga','$total_harga2','$size','$warna','$keterangan','$waktu_skg2','$tgl','$oleh')";
			$query = "INSERT into t_transaksi_temp(KENA,KODE_BARANG,KODE_DISKON,JENIS_BARANG,HARGA,HARGA_TAMBAHAN,QTY,TOTAL,TOTAL2,SIZE_,WARNA,KETERANGAN,WAKTU,TGL,OLEH) VALUES('$kena','$kode_barang','$kode_promo','$jenis_barang','$harga_satuan','$totcost','$qty','$total_harga','$total_harga2','$size','$warna','$keterangan','$waktu_skg2','$tgl','$oleh')";
