		...
		?>
            ...
            <table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
                ...
                <?php 
                    ...
                    $data = mysqli_query($koneksi, "select ID,COSTUMER,PAYMENT,SUM(`TOTAL`)AS TOTALNYA, SUM(`QTY`) AS JUMLAHH,KODE_TRANSAKSI,TGL,WAKTU,OLEH,POTONGAN from t_transaksi GROUP BY KODE_TRANSAKSI ORDER BY ID DESC");
