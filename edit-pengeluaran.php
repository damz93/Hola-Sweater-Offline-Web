		...
		<?php 
			...
			if($_SESSION['status']!="login"){
				...
				echo "<script>alert('Anda tidak memiliki akses.....');window.location.href='javascript:history.go(-1)';</script>";
				   ...
				   $tglnya = formatTanggal($row['TGL']);  
				   $keterangan = $row['NOTES'];
				   $nominal=number_format($row['NOMINAL'],0,",",".");
				   $satuan=number_format($row['PERITEM'],0,",",".");
					...
					<div class="table-responsive">
						<table border="0" class="table table-borderless" style="width:85%" cellpadding="2" cellspacing="2" align="left">
							...
							<tr>
								<th>Tanggal</th>
								<td width="5%"></td>
								<td colspan="2"><input readonly="readonly" placeholder="Tanggal Transaksi(dd/MM/yyyy)" class="form-control form-control-sm" maxlength="30" value="<?php echo $tglnya; ?>" type="text" name="tgl_transaksi" id="tgl_transaksi">  </td>
							</tr>
							...
							<tr>
								<th>Detail</th>
								<td width="5%"></td>
								<td colspan="2"><textarea  class="form-control form-control-sm" id="keterangan"  placeholder="Detail" maxlength="30" type="text" name="KETERANGAN"><?php echo $keterangan;?></textarea></td>
							</tr>
							<tr>
								<th>Harga Satuan</th>
								<td width="5%" align="right"><label>Rp</label></td>
								<td colspan="2"><input type="text" placeholder="0" id="hargasatuan" class="form-control form-control-sm mata-uang" onkeyup="inputTerbilang();" value="<?php echo $satuan;?>" name="HARGA_SATUAN" ></td>
							</tr>
							<tr>
								<th colspan="2">QTY</th>
								<td colspan="2"><input type="text" placeholder="0" value="<?php echo $qty;?>"  id="qty" class="form-control form-control-sm mata-uang" onkeyup="inputTerbilang();" name="QTY" ></td>
							</tr>
							<tr>
								...
								<label style="font-size:30px" id="nominal2"><b><?php echo "Rp".$nominal;?></b></label>
								</td>
							</tr>
							<tr align='center'>
								<td colspan="2">
								...
								<td colspan="2">
									<button type="submit" value="simpan" style="background-color:#00b050" class="btn btn-info btn-lg btn-block">Update</button></td>
								</td>
							</tr>
						</table>
					</div>
