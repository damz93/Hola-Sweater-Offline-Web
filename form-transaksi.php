          ...
          <div id="kiri">	
            ...
            <br>
				...
				<tr>
					...
					<td>
                        <button type="submit" name="sm_tx" onclick="cek_btntx()" value="ok" style="background-color:#00b050;" class="btn btn-primary btn-block">Cari</button>    
                ...
                <tr>				
                    <td colspan="2">                    
					<br>
						<a href="form-transaksi" style="color:#FFFFFe"><button type="button" style="width:100%;background-color:#e6c700;" class="btn btn-block btn-warning">Reset</button></a>
                    </td> 
				</tr>				
				</form>
                <tr>
					<td colspan="2" valign="top">
						...
						<br>
						<br>
						<a href="input-transaksi" style="color:#FFFFFe"><button type="button" style="width:100%;background-color:#366092;" class="btn btn-lg btn-secondary">Input Transaksi</button></a>
						<br><br>
			  ...
			  <div class="sc_kanan">	
				...
				<table id="tabel1" width="100%" class="table table-hover" align="center" border="1" cellpadding="0" cellspacing="1">
					...
					<?php 
						...
						if (isset($_GET['sm_tx'])) {
							...
							if(($_GET['kode_trx'])!=''){
								...
								$data_tampil2 = mysqli_query($koneksi, "select ID,COSTUMER,PAYMENT,SUM(`TOTAL`)AS TOTALNYA, SUM(`QTY`) AS JUMLAHH,KODE_TRANSAKSI,TGL,WAKTU,OLEH,POTONGAN from t_transaksi where KODE_TRANSAKSI='".$kode."' GROUP BY KODE_TRANSAKSI ORDER BY ID DESC");
							}
							else{
							...
							if(($_GET['tgl_transaksi'])!=''){
								...
								$data_tampil2 = mysqli_query($koneksi, "select ID,COSTUMER,PAYMENT,SUM(`TOTAL`)AS TOTALNYA, SUM(`QTY`) AS JUMLAHH,KODE_TRANSAKSI,TGL,WAKTU,OLEH,POTONGAN from t_transaksi where TGL='".$tgl."' GROUP BY KODE_TRANSAKSI ORDER BY ID DESC");
							}
					...
					<tr align="center">	
						...
						<td><?php echo $qty; ?></td>	
						<td align="right"><?php echo $totalnya; ?></td>	<td>
						...
						<td><a target="_BLANK" href='form-transaksi-detail?kode_transaksi=<?php
						   ...
						   <a target="_BLANK" href='cetak-transaksi2.php?kode_transaksi=<?php echo $koder; ?>' title="Cetak Nota Transaksi" onclick="return confirm('Are you sure you want to reprint?')"><img src="img/print.png" height="100%" ></a>|
				...
				<div  id="hapuss<?php echo $koder; ?>" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<!--<form id="form-hapus-pengeluaran" name="form-hapus-pengeluaran" role="form" autocomplete="off">-->
						 <form autocomplete="off" method="post" action="hapus-transaksi-new.php" onsubmit="return confirm('Yakin ingin hapus?');">
