      ...
      <table class="table-borderless dda" style="width: 100%" align='center'>
         ...
         <?php 
			...
			$total_diskon_seluruh=0;
              while($data = mysqli_fetch_array($data_barang)){								
				...
				$tot_pemasukannya = $tot_pemasukannya + $total;
				...
				$tot_sel_edc_tamp = "Rp".number_format($tot_sel_edc,0,',','.');	
				...
				$tot_sel_tf_tamp = "Rp".number_format($tot_sel_tf,0,',','.');
				...
				$tot_sel_cash_tamp = "Rp".number_format($tot_sel_cash,0,',','.');
		...
		<tr style="background-color:#d0d0d0">
		 ...
		 <tr style="background-color:#b8b8b8">
			<td colspan='6' align='center'><h4>Total Pemasukan</h4></td>
			<td align='center'><h4><?php echo "Rp".$tot_pemasukannya_tamp; ?></h4></td>
		</tr>
      </table>
