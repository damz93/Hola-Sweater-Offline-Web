...
<html>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      <title>Data Voucher - H O L A S W E A T E R</title>
...
<div class="bg">
	...
	<h1 align='center' style="background-color:#71b8e4;color:#FFFFFe">UPLOAD VOUCHER</h1>
      <h3 align='center' style="background-color:#1d7bb6;color:#FFFFee">- H O L A S W E A T E R -</h3>
      <br>      
	  <a style="background-color:#71b8e4;color:#FFFFFe" href="form-diskon"><button type="button" class="btn btn-info">[ Kembali ke Data Diskon ]</button> </a><br>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">			
	<tr>
		<td align="center">
		
			<a style="background-color:#217346;color:#FFFFFe" target="_BLANK" href='template/format_upload_voucher.xlsx'><button type="button" class="btn btn-primary">DOWNLOAD FORMAT EXCEL</button> </a>
	...
	<tr>
		<td align="center">
			...
			<form class="" method="post" enctype="multipart/form-data" action="upload-aksi-voucher" align='center'>
				<label for="exampleInputFile">Pilih File: </label>
				<input name="berkas_voucher" type="file" required="required" id="exampleInputFile"><br>
	...
	<br>
			...
			<table id="tabel1" class="table table-hover" border="1" cellpadding="0" cellspacing="1">
				...
				<?php
					include "koneksi.php";
					$no=1;
					$data = mysqli_query($koneksi, "select * from t_voucher order by STATUS,ID ASC");
				...
				<tr>
					...
					<td align="center"><?php echo $d['KODE_VOUCHER'];?></td>
					<td align="center"><?php echo $d['NAMA_VOUCHER'];?></td>
				 ...
				 $(document).ready(function() {
					 ...
					 $("#tabel1").DataTable({
						 ...
						 "language": {
							 ...
							 "infoPostFix": "",
							 "thousands": ".",
							 "lengthMenu": "Menampilkan _MENU_ Data Voucher",
